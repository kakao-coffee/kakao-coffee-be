package com.kakaoCoffee.common.config;

import com.kakaoCoffee.common.jwt.JwtAuthFilter;
import com.kakaoCoffee.common.jwt.JwtUtil;
import com.kakaoCoffee.common.security.CustomAccessDeniedHandler;
import com.kakaoCoffee.common.security.CustomAuthenticationEntryPoint;
...
//        http.headers().frameOptions().disable();
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/beverages/**").permitAll()
